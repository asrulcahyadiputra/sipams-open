...
$(document).ready(function () {
    ...
    if (echartElemBar) {
        ...
        echartBar.setOption({
            legend: {
                ...
                orient: "horizontal",
                x: "right",
                data: ["Pendapatan Usaha", "Pendapatan Kerja Sama"],
            },
            grid: {
                left: "8px",
                right: "8px",
    ...
    if (echartElemPie) {
        ...
        echartPie.setOption({
            ...
            series: [
                {
                    name: "Pengeluaran Berdasarkan Kategori",
                    type: "pie",
                    radius: "60%",
                    center: ["50%", "50%"],
                    data: [
            ...
            _objectSpread(
                ...
                {},
                {
                    series: [
                        {
                            data: [
                                40, 80, 20, 90, 30, 80, 40, 90, 20, 80, 30, 45,
                                50, 110, 90, 145, 120, 135, 120, 140,
                            ],
